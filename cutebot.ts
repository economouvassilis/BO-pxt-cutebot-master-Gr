...
namespace cuteBot {
    ...
    */
    //% blockId=cutebot_move_time block="Κινήσου %dir με ταχύτητα%speed\\% για %time δευτερόμεπτα"
    //% weight=95
    ...
    */
     ...
     */
    //% blockId=cutebot_servo block="Όρισε γωνία servo %servo σε %angle °"
...
namespace joystickbit {
    ...
    */
    //% blockId=initJoystickBit block="Αρχικοποίηση joystick:bit"
    ...
    * get Button
    */
    //% blockId=getButton block="Το %button έχει πατηθεί"
    ...
    */
    //% blockId=getRockerValue block="Η τιμή του %rocker"
